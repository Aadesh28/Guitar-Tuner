...
//      This array contains all pitches for all notes in the 2nd to 6th octaves.First, the octaves are mapped to arrays of    pitches for each note within each octave.
...
/*
 * override the add operator so i can get to the next (or previous) pitches
...
/*
 * Lastly,need to override the - operator too but i can simply call +
